...
public class DragDropPage {
	...
	public void DragButton() throws IOException {
		...
		Boolean check = true;
		wb = (WebElement) js.executeScript("document.querySelector(\"div[id = 'dragbox']\")");
	...
	public void DragTest() throws IOException {
		...
		WebElement From= (WebElement) js.executeScript("document.querySelector(\"div[id = 'dragbox']\")");	
        WebElement To= (WebElement) js.executeScript("document.querySelector(\"div[id = 'dropbox']\")");									
