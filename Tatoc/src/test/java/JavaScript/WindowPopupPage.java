...
public class WindowPopupPage {
	...
	public void WindowLinks() throws IOException {
		...
		wb = (WebElement) js.executeScript("document.querySelector(\"a[onclick = 'launchwindow();']\")");
	    ...
	    wb = (WebElement) js.executeScript("document.querySelector(\"a[onclick='gonext();'] \")");
	...
	public void WindowButton() throws IOException {
		...
		wb = (WebElement) js.executeScript("document.getElementById('name')");
		...
		wb = (WebElement) js.executeScript("document.getElementById('submit')");
